...
// 鍒濆�嬪寲 鑳屽厜 寮曡剼  
		GPIO_InitStruct.Pin 		= GPIO_PIN_15;				// 鑳屽厜 寮曡剼
		GPIO_InitStruct.Mode 	= GPIO_MODE_OUTPUT_PP;			// 鎺ㄦ尳杈撳嚭妯″紡
		GPIO_InitStruct.Pull 	= GPIO_NOPULL;						// 鏃犱笂涓嬫媺
		GPIO_InitStruct.Speed 	= GPIO_SPEED_FREQ_LOW;			// 閫熷害绛夌骇浣�
		HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);	// 鍒濆�嬪寲  

// 鍒濆�嬪寲 鏁版嵁鎸囦护閫夋嫨 寮曡剼  
		GPIO_InitStruct.Pin 		= GPIO_PIN_15;				      // 鏁版嵁鎸囦护閫夋嫨 寮曡剼
		GPIO_InitStruct.Mode 	= GPIO_MODE_OUTPUT_PP;			// 鎺ㄦ尳杈撳嚭妯″紡
		GPIO_InitStruct.Pull 	= GPIO_NOPULL;						// 鏃犱笂涓嬫媺
		GPIO_InitStruct.Speed 	= GPIO_SPEED_FREQ_LOW;			// 閫熷害绛夌骇浣�
		HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);	      // 鍒濆�嬪寲  
