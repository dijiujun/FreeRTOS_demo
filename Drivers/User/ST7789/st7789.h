...
#define ST7789_BL_Clr() HAL_GPIO_WritePin(ST7789_BL_PORT, ST7789_BL_PIN, GPIO_PIN_RESET)
#define ST7789_BL_Set() HAL_GPIO_WritePin(ST7789_BL_PORT, ST7789_BL_PIN, GPIO_PIN_SET)
...
#else
#define ST7789_Select() __asm{nop}
#define ST7789_UnSelect() __asm{nop}
#endif
